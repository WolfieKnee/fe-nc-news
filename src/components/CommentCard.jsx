...
export default function CommentCard({comment, commentsList, setCommentsList}){
    ...
    <li className="comment-card__li">
        ...
        <DeleteComment comment_id={comment.comment_id} commentsList={commentsList} setCommentsList={setCommentsList}/>:null
        } */}
    </li>
    )
